const select = document.getElementById('filtroSelect');
  ...
  select.addEventListener('change', function () {
    ...
    // let alertaRiscoX = div_ultima_hora.value;
    // let alertaRiscoY = div_ultimo_dia.value;
    // let alertaRiscoZ = div_ultima_semana.value;
...
// const canvasNormalX = document.getElementById('metrica-Barras-alerta-normal-x').getContext('2d');
...
// const labelsNormalX = ['00:15:00', '00:30:00', '00:45:00', '01:00:00'];

// // Criação inicial do gráfico
// const graficoNormalX = new Chart(canvasNormalX, {
//   type: 'bar',
//   data: {
//     labels: labelsNormalX,
//     datasets: [
//       {
//         label: 'Rua x1',
//         data: dadosNormalX[2025][0],
//         borderColor: 'black',
//         backgroundColor: 'rgb(90, 245, 227)'
//       },
//       {
//         label: 'Rua x2',
//         data: dadosNormalX[2025][1],
//         backgroundColor: 'rgb(30, 208, 186)'
//       },
//       {
//         label: 'Rua x3',
//         data: dadosNormalX[2025][2],
...
// const canvasNormalY = document.getElementById('metrica-Barras-alerta-normal-y').getContext('2d');
...
// // Atualizado por semanas
// const labelsNormalY = ['06:00', '12:00', '18:00', '23:00'];

// // Criação inicial do gráfico
// const graficoNormalY = new Chart(canvasNormalY, {
//   type: 'bar',
//   data: {
//     labels: labelsNormalY,
//     datasets: [
//       {
//         label: 'Rua y1',
//         data: dadosNormalY[2025][0],
//         borderColor: 'black',
//         backgroundColor: 'rgb(90, 245, 227)'
//       },
//       {
//         label: 'Rua y2',
//         data: dadosNormalY[2025][1],
//         backgroundColor: 'rgb(30, 208, 186)'
//       },
//       {
//         label: 'Rua y3',
//         data: dadosNormalY[2025][2],
//         backgroundColor: 'rgb(42, 157, 143)'
//       },
...
// const canvasNormalZ = document.getElementById('metrica-Barras-alerta-normal-z').getContext('2d');
...
// // Atualizado por semanas
// const labelsNormalZ = [ 'Dom', 'Seg', 'Ter', 'Quar', 'Quin', 'Sex', 'Sáb'];

// // Criação inicial do gráfico
// const graficoNormalZ = new Chart(canvasNormalZ, {
//   type: 'bar',
//   data: {
//     labels: labelsNormalZ,
//     datasets: [
//       {
//         label: 'Rua z1',
//         data: dadosNormalZ[2025][0],
//         borderColor: 'black',
//         backgroundColor: 'rgb(90, 245, 227)'
//       },
//       {
//         label: 'Rua z2',
//         data: dadosNormalZ[2025][1],
//         backgroundColor: 'rgb(30, 208, 186)'
//       },
//       {
//         label: 'Rua z3',
//         data: dadosNormalZ[2025][2],
//         backgroundColor: 'rgb(42, 157, 143)'
//       },
